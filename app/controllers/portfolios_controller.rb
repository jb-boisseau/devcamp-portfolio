class PortfoliosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @portfolio.save
        format.html { redirect_to portfolios_path, notice: 'The portfolio item is now live.' }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @portfolio_item.update(params.require(:portfolio).permit(:title, :subtitle, :body))
        format.html { redirect_to portfolios_path, notice: 'This Portfolio was successfully updated.' }
      else
